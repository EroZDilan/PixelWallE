...
public class Lexer
{
    ...
    private Token? GetNextToken(ref string line)
    {
        ...
        Match function = Regex.Match(line, @"^GetActualX|^GetActualY|^GetCanvasSize|^IsBrushColor|^IsBrushSize|^IsCanvasSize|^GetColorCount|^IsCanvasColor");
        ...
        Match identifier = Regex.Match(line, @"^[a-zA-ZáéíóúÁÉÍÓÚüÜñÑ][a-zA-ZáéíóúÁÉÍÓÚüÜñÑ0-9_]*");
